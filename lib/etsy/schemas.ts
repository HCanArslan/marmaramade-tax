...
export const etsyReceiptSchema = z.object({ receipt_id: z.number().int().positive(), create_timestamp: z.number().int(), update_timestamp: timestamp, is_paid: z.boolean().optional(), is_shipped: z.boolean().optional(), country_iso: z.string().optional(), state: z.string().optional(), zip: z.string().optional(), grandtotal: moneySchema, subtotal: moneySchema.optional(), total_shipping_cost: moneySchema.optional(), total_tax_cost: moneySchema.optional(), discount_amt: moneySchema.optional(), transactions: z.array(z.object({ transaction_id: z.number().int().positive(), listing_id: z.number().int().optional(), title: z.string(), quantity: z.number().int(), price: moneySchema, sku: z.string().nullable().optional() }).passthrough()).optional() }).passthrough();
