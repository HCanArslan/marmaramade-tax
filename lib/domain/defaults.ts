...
export const defaultCalculatorInput: CalculatorInput = {
  itemSubtotalUsd: "150",
  shippingChargedToBuyerUsd: "0",
  giftWrapChargedToBuyerUsd: "0",
  sellerFundedDiscountUsd: "0",
  etsyFundedDiscountUsd: "0",
  taxCollectedFromBuyerUsd: "0",
  numberOfListingCharges: "1",
  transactionRate: "6.5",
  processingRate: "6.5",
  ...
  offsiteAdAttributed: false,
  offsiteAdsRate: "15",
  offsiteAdsMaximumUsd: "100",
  listingFeeUsd: "0.20",
  etsyAdsUsd: "0",
  depositFeeApplies: false,
  depositFeeTry: "42",
  vatTreatment: "CHARGED_BY_ETSY",
  sellerFeeVatRate: "20",
  ...
  domesticTransferCostTry: "0",
  transportToCarrierBranchTry: "0",
  pickupFeeTry: "0",
  nonPartnerShipmentCostTry: "0",
  internationalShippingUsd: "0",
  shippingInsuranceUsd: "0",
  customsDutyUsd: "0",
  additionalTariffUsd: "0",
  carrierProcessingFeeUsd: "0",
  brokerageFeeUsd: "0",
  customsClearanceFeeUsd: "0",
  destinationFeesUsd: "0",
